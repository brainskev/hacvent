...
export default function FAQ() {
  ...
  const categories = ['All', 'General', 'Eligibility', 'Application', 'Contractors', 'Stacking', 'Federal', 'Timing', 'ThermoGrid']
  ...
  return (
    <>
      <Head>
        <title>FAQ - HVAC Rebate Questions Answered | ThermoGrid</title>
        <meta name="description" content="Get answers to all your HVAC rebate questions. Learn about eligibility, application process, and maximizing your savings." />
      </Head>
        ...
        <section className="bg-gradient-to-br from-primary to-secondary py-16">
          <div className="container-custom text-white text-center">
            ...
            <p className="text-xl text-white/90 mb-8">
              Everything you need to know about HVAC rebates and ThermoGrid
            </p>
          ...
          <div className="max-w-4xl mx-auto mt-12">
            <div className="card bg-gradient-to-br from-primary/10 to-secondary/10 border-2 border-primary/20 text-center">
              ...
              <p className="text-gray-700 mb-6">
                Our support team is here to help you with any questions about HVAC rebates or using ThermoGrid.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="mailto:support@thermogrid.com" className="btn-primary">
                  Email Support
                </a>
